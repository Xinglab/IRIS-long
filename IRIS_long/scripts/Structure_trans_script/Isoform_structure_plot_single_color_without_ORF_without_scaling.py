...
outf_name_pdf = f"{file_dir}/{gene_name}_{trans_ID_list[-1]}_isoform_structure.pdf"
plt.savefig(outf_name_pdf,dpi=300, pad_inches=0)

outf_name_png = f"{file_dir}/{gene_name}_{trans_ID_list[-1]}_isoform_structure.png"
