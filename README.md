...
IRIS-long requires some processed file, which could be downloaded from [IRIS_long_references](http://samtools.sourceforge.net) (a Google Drive link; size of file is around 4 GB). 
