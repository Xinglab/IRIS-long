...
def parse_args():
	...
	parser_translate.add_argument('-rg', '--ref_gtf', dest='ref_gtf', type=str, help='reference gencode annotation, e.g. ./references/gencode.v39.annotation.gtf', required=True)
