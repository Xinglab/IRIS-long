...
with open("%s/references/gencode.v39.annotation.gtf" % dir_path,"r") as gtf_hg38:
...
with open("%s/references/gencode.v34lift37.annotation.gtf" % dir_path,"r") as gtf_hg19:
