...
if genome_version in ["hg38","GRCh38"]:
	gtf_file_name = '%s/../references/gencode.v39.annotation.gtf' % dir_path
elif genome_version in ["hg19","GRCh37"]:
	gtf_file_name = '%s/../references/gencode.v34lift37.annotation.gtf' % dir_path
else:
	gtf_file_name = genome_version

with open(gtf_file_name,'r') as gencode_gtf:
