...
for line in transcript_inf:
	...
	### ENST 2 Uni #######
	if re.findall('-\d+',Uni_ID):  #isoform
...
if used_genome in ['hg19','HG19','GRCh37']:
	gencode_fasta_inf_name = "%s/references/gencode.v34lift37.pc_translations.fa" % dir_path
elif used_genome in ['hg38','HG38','GRCh38']:
	gencode_fasta_inf_name = "%s/references/gencode.v39.pc_translations.fa" % dir_path
